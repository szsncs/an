...
var Equipment={
	...
	image : "", //图片路径
	type : "1",
	viewid : "com.sunnercn.equipment.EquipMaintController",
	init:function(){
		Equipment.initPage();
		Equipment.initAdd();
		Equipment.initInfo();
	...
	sumbitCallAction : function(json){//调用新增服务
		...
		callAction(Equipment.viewid,"save",json,"savecallBack");
	},
	deleteCallAction : function(json){//调用删除服务
		summer.showProgress({
			"title" : "加载中..."
		});
		callAction(Equipment.viewid,"delete",json,"deletecallBack");
	},
	updateCallAction : function(json){//调用修改服务
		summer.showProgress({
			"title" : "加载中..."
		});
		callActionContainsFile(Equipment.viewid,"update",Equipment.image,json,"updatecallBack");
	},
	initAdd : function(){//新增初始化
		...
		callAction(Equipment.viewid,"addInit",json,"addInitcallBack");
	},
	initInfo : function(){//详情初始化
		...
		callAction(Equipment.viewid,"queryInit",json,"queryInitcallBack");
	},
